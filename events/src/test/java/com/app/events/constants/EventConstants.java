...
public class EventConstants {
	...
	public static final Date UPDATE_EVENT_FROM_DATE = new GregorianCalendar(2021, Calendar.JUNE, 1).getTime();
	public static final Date UPDATE_EVENT_TO_DATE = new GregorianCalendar(2021, Calendar.JUNE, 2).getTime();
