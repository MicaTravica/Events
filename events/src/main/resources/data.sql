...
INSERT INTO `events_database`.`sector` (`id`, `name`, `sector_columns`, `sector_rows`, `hall_id`) VALUES ('1', 'sektor1', '2', '1', '1');
...
INSERT INTO `events_database`.`seat` (`id`, `seat_column`, `seat_row`, `sector_id`) VALUES ('2', '2', '1', '1');
...
INSERT INTO `events_database`.`ticket` (`id`, `bar_code`, `price`, `ticket_state`, `version`, `event_id`, `seat_id`) VALUES ('2', 'DFA', '100.00','RESERVED', '0', '1', '2');
INSERT INTO `events_database`.`ticket` (`id`, `bar_code`, `price`, `ticket_state`, `version`, `event_id`, `sector_capacity_id`) VALUES ('3', 'DFA', '100.00','RESERVED', '0', '1', '4');
...
INSERT INTO `events_database`.`sector_capacity` (`id`, `capacity`, `free`, `sector_id`) VALUES ('4', '100', '90', '2');