	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
			...
			.authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, "/api/event/**", "/api/hall/**", "/api/media/**", "/api/media/event/**", "/api/place/**", "/api/places", "/api/priceList/**", "/api/seats/**", "/api/sectorCapacity/**", "/api/sector/**").permitAll()
