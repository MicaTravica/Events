	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
			...
			.authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, "/api/ticketsForEvent/**","/api/event/**", "/api/hall/**", "/api/media/**", "/api/media/event/**", "/api/place/**", "/api/priceList/**", "/api/seats/**", "/api/sectorCapacity/**", "/api/sector/**").permitAll()
